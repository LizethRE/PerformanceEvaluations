            ...
            <div class="container-fluid"  style="margin: 0px 0;">
                <div class="row">
                    <div class="col-xs-12 col-sm-4 col-md-3">
                        <img src="../../assets/imgs/viewPeriod.png" alt="view" class="img-responsive center-box" style="max-width: 110px;">
                    </div>
                    <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                        En esta sección puede visualizar la lista de los periodos academicos.
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="table-responsive">
                                            <div id = "period_list" method="post">
                                                <table id="dataTables-example" class="table table-striped text-center" border="1"style="border: #8080802e 1px solid">
                                                    ...
                                                    <tbody>
                                                    <tr>
                                                        <td class="text-center" id="nombre">descripcion</td>
                                                        <td class="text-center" id="codigo">fechaI</td>
                                                        <td class="text-center" id="departamento">fechaF</td>
                                                        <td>
                                                            <button type="reset" class="btn btn-danger" style="margin-right: 20px">Editar</button>
