...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container nav-espacio">
            <h1 class="all-tittles">Progreso de las evaluaciones</h1>
        </div>
            ...
            <div class="container-fluid"  style="margin: 0px 0;">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                        En esta sección puede visualizar la lista de docentes con el respectivo progreso de sus evaluación.
                    </div>
                    <div class="container-fluid contai-espacio">
                        <div class="container-flat-form">
                            <div class="title-flat-form title-flat-red">Progreso</div>
                            <div class="container-fluid"  style="margin: 50px 0;">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="table-responsive">
                                            <div id = "progress" method="post">
                                                <table class="table table-hover text-center" border="1"style="border: #8080802e 1px solid">
                                                    <table id="dataTables-example" class="table table-striped text-center" border="1"style="border: #8080802e 1px solid">
                                                        <thead>
                                                        <tr class="danger">
                                                            <th class="text-center">Nombre de docente</th>
                                                        ...
                                                        <tbody>
                                                        <tr>
                                                            <td class="text-center" id="inicio">nombre</td>
                                                            <td class="text-center" id="fin">codigo</td>
                                                            <td class="text-center" id="progress">incompleto</td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                            </div>
