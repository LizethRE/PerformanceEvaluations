...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container nav-espacio">
            <h1 class="all-tittles">Agregar periodo</h1>
        </div>
        <section class="full-reset text-center" style="padding: 40px 0;">
            <div class="container-fluid"  style="margin: 0px 0;">
                <div class="row">
                    <div class="col-xs-12 col-sm-4 col-md-3">
                        <img src="../../assets/imgs/addPeriod.png" alt="user" class="img-responsive center-box" style="max-width: 110px;">
                    </div>
                    <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                        En esta sección puede agregar un periodo academico.<br>
                        Rellene los campos del formulario a continuación:
                    </div>
                    <div class="container-fluid contai-espacio">
                        <div class="container-flat-form">
                            <div class="title-flat-form title-flat-red">Agregar periodo</div>
                            <div class="container-fluid">
                                <!--Formulario de añadir periodo-->
                                <form id="add_period" action="../../include.php" method="post">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                                            <div class="group-material">
                                                <input type="date" name="fechaInicio" class="material-control tooltips-general" required="" data-toggle="tooltip">
                                                <span class="highlight"></span>
                                                <span class="bar"></span>
                                                <label>Fecha inicial</label>
                                            </div>
                                            <div class="group-material">
                                                <input type="date" name="fechaFin" class="material-control tooltips-general" required="" maxlength="20" data-toggle="tooltip">
                                                <span class="highlight"></span>
                                                <span class="bar"></span>
                                                <label>Fecha final</label>
                                            </div>
                                            <div class="group-material">
                                                <input type="text" name="descripcion" class="material-control tooltips-general" placeholder="Descripción" required="" maxlength="20" data-toggle="tooltip">
                                                <span class="highlight"></span>
                                                <span class="bar"></span>
                                            ...
                                            <p class="text-center">
                                                ...
                                                <!-- Router -->
                                                <input type="hidden" name="solicitud" value="addPeriod">
                                            </p>
                                        </div>
                                    </div>
                                </form>
