...
<html lang="es">
<head>
    <title>Performance Evaluations - Evaluacion Docente</title>
    <!-- Meta -->
    <meta charset="utf-8">
...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container nav-espacio">
            <h1 class="all-tittles">Evaluación a docentes</h1>
        </div>
                            ...
                            <div class="container-fluid"  style="margin: 50px 0;">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <form id="docente_director" action="../../include.php" method="post" autocomplete="off">
                                            <div class="table-responsive">
                                                ...
                                                <p class="text-center">
                                                    ...
                                                    <!-- Router -->
                                                    <input type="hidden" name="solicitud" value="teacherDir">
                                                </p>
                                            </div>
                                        </div>
                                    </form>
